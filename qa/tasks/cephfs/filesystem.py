...
class Filesystem(MDSCluster):
    ...
    def _remove_pool(self, name):
        return self.mon_manager.raw_cluster_cmd('osd', 'pool', 'rm', name, name, '--yes-i-really-really-mean-it')

    def rm(self, **kwargs):
        return self.mon_manager.raw_cluster_cmd('fs', 'rm', self.name, '--yes-i-really-mean-it', **kwargs)
