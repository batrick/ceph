...
class FSMissing(Exception):
    def __init__(self, fscid):
        self.fscid = fscid

    def __str__(self):
        return f"File system fscid={self.fscid} does not exist in the map"
...
class Filesystem(MDSCluster):
    ...
    def required_client_features(self, *args):
        ...
        return self.mon_manager.run_cluster_cmd(args=c, stdout=StringIO(), stderr=StringIO())
