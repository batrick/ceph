...
class TestDamage(CephFSTestCase):
    ...
    def test_object_deletion(self):
        ...
        omap_keys = []
        for o in objects:
            keys_str = self.fs.radosmo(["listomapkeys", o])
            if keys_str:
        ...
        for obj_id in objects:
            stat_out = self.fs.radosmo(["stat", obj_id])
        ...
        for obj_id in data_objects:
            if obj_id == "500.00000000":
                ...
                mutations.append(MetadataMutation(
                    ...
                    lambda o=obj_id: self.fs.radosm(["put", o, "-"], stdin=BytesIO(junk)),
                    READONLY
                ))
            else:
                mutations.append(MetadataMutation(
