...
""")
    ...
    def test_dirfrag_limit(self):
        ...
        try:
            self.mount_a.create_n_files("subdir/file", LOW_LIMIT+1, dirsync=True)
    ...
    def test_dirfrag_limit_fragmented(self):
        ...
        self.mount_a.create_n_files("subdir/file", LOW_LIMIT, dirsync=True)
        ...
        self.mount_a.mount_wait()
        self.mount_a.create_n_files("subdir/file", (LOW_LIMIT*3)//2, dirsync=True)
