...
class TestSnapSchedules(CephFSTestCase):
    ...
    def verify_schedule(self, dir_path, schedules, retentions=[]):
        ...
        result = self.fs_snap_schedule_cmd('list', path=f'{dir_path}', format='json')
    ...
    def test_non_existent_snap_schedule_list(self):
        ...
        try:
            self.fs_snap_schedule_cmd('list', path=f'{TestSnapSchedules.TEST_DIRECTORY}')
    ...
    def test_snap_schedule_list_post_schedule_remove(self):
        ...
        self.fs_snap_schedule_cmd('add', path=f'{TestSnapSchedules.TEST_DIRECTORY}', **{'snap-schedule':'1h'})

        self.fs_snap_schedule_cmd('remove', path=f'{TestSnapSchedules.TEST_DIRECTORY}')
    ...
    def test_snap_schedule(self):
        ...
        self.fs_snap_schedule_cmd('add', path=f'{TestSnapSchedules.TEST_DIRECTORY}', **{'snap-schedule':'1M'})
        exec_time = time.time()
    ...
    def test_multi_snap_schedule(self):
        ...
        self.fs_snap_schedule_cmd('add', path=f'{TestSnapSchedules.TEST_DIRECTORY}', **{'snap-schedule':'1M'})
        self.fs_snap_schedule_cmd('add', path=f'{TestSnapSchedules.TEST_DIRECTORY}', **{'snap-schedule':'2M'})
        exec_time = time.time()
    ...
    def test_snap_schedule_with_retention(self):
        ...
        # set a schedule on the dir
        self.fs_snap_schedule_cmd('add', path=f'{TestSnapSchedules.TEST_DIRECTORY}', **{'snap-schedule':'1M'})
        self.fs_snap_schedule_cmd('retention', 'add', path=f'{TestSnapSchedules.TEST_DIRECTORY}', **{'retention-spec-or-period':'1M'})
        exec_time = time.time()
