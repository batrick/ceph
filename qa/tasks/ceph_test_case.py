...
class CephTestCase(unittest.TestCase):
    ...
    def config_get(self, section, key):
       return self.ceph_cluster.mon_manager.raw_cluster_cmd("config", "get", section, key)

    def config_show(self, entity, key):
       return self.ceph_cluster.mon_manager.raw_cluster_cmd("config", "show", entity, key)
