...
may be randomly ephemerally pinned. This is set through the extended attribute
...
randomly ephemerally pinned 50 percent of the time.
...
``mds_export_ephemeral_random_max`` and ``mds_export_ephemeral_distributed``
