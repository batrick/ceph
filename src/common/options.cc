...
std::vector<Option> get_mds_client_options() {
  return std::vector<Option>({
    ...
    .set_default(300.0)
    .set_description("timeout for client mount of CephFS"),
    ...
    .set_default(5.0)
    .set_description("maximum age of dirty pages in object cache"),
    ...
    .set_default(true)
    .set_description("synchronize all local metadata/file chaanges after snapshot"),
