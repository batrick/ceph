...
class TestFS(TestArgparse):
    ...
    def test_fs_set_max_mds(self):
        self.check_valid_command('fs', 'set', 'default', '1')
        self.check_valid_command('fs', 'set', 'default', '2')

    def test_fs_set_cluster_down(self):
        self.check_no_arg('fs', 'set', 'default', 'cluster_down', 'true')

    def test_fs_set_cluster_up(self):
        self.check_no_arg('fs', 'set', 'default', 'cluster_down', 'false')
