...
void Server::recall_client_state(void)
{
  ...
  uint64_t max_caps_per_client = (uint64_t)(Capability::count() * g_conf->get_val<float>("max_ratio_caps_per_client"));
  uint64_t min_caps_per_client = (uint64_t)g_conf->get_val<int>("min_caps_per_client");
