...
public:
  ...
  void decode_replica_dir(CDir *&dir, bufferlist::iterator& p, CInode *diri, mds_rank_t from, list<MDSInternalContextBase*>& finished);
  void decode_replica_dentry(CDentry *&dn, bufferlist::iterator& p, CDir *dir, list<MDSInternalContextBase*>& finished);
  void decode_replica_inode(CInode *&in, bufferlist::iterator& p, CDentry *dn, list<MDSInternalContextBase*>& finished);
