...
void MDCache::create_empty_hierarchy(MDSGather *gather)
{
  ...
  ceph_assert(rootdir->fnode.accounted_fragstat == rootdir->fnode.rstat);
  ceph_assert(rootdir->fnode.fragstat == rootdir->fnode.accounted_fragstat);
  rootdir->fnode.accounted_rstat = rootdir->fnode.rstat = root->inode.rstat;
