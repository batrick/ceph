...
bool MDCache::shutdown_pass()
{
  ...
  // trim the log such that the cache eventually becomes clean. Note also
  // that trimming the log should occur after exports of subtrees to
  // eliminate unnecessary metadata pool traffic.
  mds->mdlog->trim(0);
