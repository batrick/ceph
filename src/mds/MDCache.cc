...
void MDCache::dispatch_quiesce_inode(const MDRequestRef& mdr)
{
  ...
  auto* qfinisher = static_cast<C_MDS_QuiesceSubvolume*>(mdr->internal_op_private);
...
void MDCache::dispatch_quiesce_path(const MDRequestRef& mdr)
{
  ...
  C_MDS_QuiesceSubvolume* qfinisher = static_cast<C_MDS_QuiesceSubvolume*>(mdr->internal_op_finish);
  auto& qs = *qfinisher->qs;
...
MDRequestRef MDCache::quiesce_path(filepath p, C_MDS_QuiesceSubvolume* c, Formatter *f, std::chrono::milliseconds delay) {
