...
protected:
  std::unique_ptr<scrub_info_t> scrub_infop;// FIXME scrub_info_t not in mempool
  ...
  // popularity
  dirfrag_load_vec_t pop_me; // FIXME vector not in mempool
  dirfrag_load_vec_t pop_nested; // FIXME vector not in mempool
  dirfrag_load_vec_t pop_auth_subtree; // FIXME vector not in mempool
  dirfrag_load_vec_t pop_auth_subtree_nested; // FIXME vector not in mempool
...
public:
  ...
  // -- waiters --
protected:
  mempool::mds_co::compact_map< string_snap_t, mempool::mds_co::list<MDSInternalContextBase*> > waiting_on_dentry;
